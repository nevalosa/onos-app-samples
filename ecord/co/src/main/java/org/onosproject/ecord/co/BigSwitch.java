 ...
 */
public final class BigSwitch implements Alarm {
     ...
     */
    private BigSwitch(final AlarmId id,
    ...
    public boolean equals(final Object obj) {
        ...
        final BigSwitch other = (BigSwitch) obj;
    ...
    public static class Builder {
        ...
        public BigSwitch build() {
            ...
            return new BigSwitch(id, deviceId, description, source, timeRaised, timeUpdated, timeCleared,
